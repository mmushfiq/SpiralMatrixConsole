...
public class Main3_1 {
    private static int row, col, matrix[][], center;
    ...
    public static void main(String[] args){
        ...
        center = (row%2==0 && col%2==0) ? 4 : ((row%2==0 || col%2==0) ? 2:1);
        center = new Random().nextInt(center)+1;
        
//        if(center!=1) System.out.println("Please enter center element number: 1 - " + center);
//        center = sc.nextInt();
